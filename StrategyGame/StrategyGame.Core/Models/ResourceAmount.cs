...
/// </summary>
public record ResourceAmount(int Food = 0, int People = 0, int Focus = 0)
{
    ...
    public ResourceAmount Add(ResourceAmount other) =>
        new(Food + other.Food, People + other.People, Focus + other.Focus);
    ...
    public bool CanAfford(ResourceAmount cost) =>
        Food >= cost.Food && People >= cost.People && Focus >= cost.Focus;

    public bool IsEmpty => Food == 0 && People == 0 && Focus == 0;
